...
$estado="I";// AI
  ...
  if($usuariopk==null)
  {
    ...
    $sql = "Update CL_Clientes Set US_usuariomod='$usuariopk',CL_estado='$estado',CL_UltModificacion=Now() Where id='$id'";
    */
       $sql = "Update CL_Clientes Set CL_estado='$estado',CL_UltModificacion=Now() Where id='$id'";
